...
export class HealthMonitor {
  ...
  public clearAlert(alertId: string): void {
    ...
    if (alert) {
      ...
      logger.info('Health alert resolved', { alertId, checkName: alert.checkName })
    }
  }
  ...
  private calculateOverallHealth(checks: Record<string, HealthCheckResult>): 'healthy' | 'degraded' | 'critical' {
