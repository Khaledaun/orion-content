          ...
          messages: [
            {
              role: "system",
              content:
                "You are a helpful research assistant. Provide accurate, well-sourced information and always include relevant sources.",
            },
            {
              role: "user",
              content: query,
...
Ensure all information is accurate and well-sourced.`;
  ...
  private calculateCost(
    ...
    const pricing =
      PERPLEXITY_PRICING[model as keyof typeof PERPLEXITY_PRICING];
    if (!pricing) {
