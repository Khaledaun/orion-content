...
export const dictionaries: Record<string, Dictionary> = {
  en: {
    ...
    auth: {
      ...
      needToBeAuthenticated: 'You need to be authenticated to access the content management system.',
    },
    onboarding: {
    ...
    credentials: {
      ...
      description: 'Securely store and manage your API keys and credentials using AES-GCM encryption.',
      encryptionKey: 'Encryption Key',
      addNew: 'Add New Credential',
      addNewDescription: 'Store a new encrypted credential in your browser\'s local storage.',
      name: 'Name',
      type: 'Type',
  ...
  ar: {
    ...
    auth: {
      ...
      needToBeAuthenticated: 'تحتاج إلى تسجيل الدخول للوصول إلى نظام إدارة المحتوى.',
    },
    onboarding: {
    ...
    credentials: {
      ...
      description: 'قم بتخزين وإدارة مفاتيح API وأوراق الاعتماد بأمان باستخدام تشفير AES-GCM.',
      encryptionKey: 'مفتاح التشفير',
      addNew: 'إضافة بيانات اعتماد جديدة',
      addNewDescription: 'تخزين بيانات اعتماد مشفرة جديدة في التخزين المحلي للمتصفح.',
      name: 'الاسم',
      type: 'النوع',
  ...
  he: {
    ...
    credentials: {
      title: 'ניהול אישורים',
      description: 'אחסן ונהל במאובטח את מפתחות ה-API והאישורים שלך באמצעות הצפנת AES-GCM.',
