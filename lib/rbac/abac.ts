...
export class ABACEngine {
  ...
  async authorize(request: AuthorizationRequest): Promise<AuthorizationResult> {
    ...
    try {
      ...
      return {
        ...
        reason: allowed
          ? "Access granted"
          : "Conditions not met for any applicable permissions",
        matchedPermissions,
        appliedConditions,
      };
    } catch (error) {
  ...
  private async evaluateCondition(
    ...
    switch (condition.context) {
      case "user":
        attributeValue =
          this.getNestedValue(context.user.attributes, condition.attribute) ||
      ...
      case "resource":
        ...
        break;
      case "environment":
        attributeValue = this.getNestedValue(
          context.environment,
          condition.attribute,
        );
        break;
  ...
  private getDemoPermissions(roles: string[]): Permission[] {
    ...
    if (roles.includes("EDITOR")) {
      permissions.push(
        ...
        {
          id: "editor-content-update",
          name: "Update Content",
          resource: "content",
          action: "update",
        },
        {
          id: "editor-content-read",
          name: "Read Content",
          resource: "content",
          action: "read",
        },
