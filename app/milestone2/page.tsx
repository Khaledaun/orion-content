    ...
    <div className="container mx-auto py-8 space-y-8">
      ...
      <div className="text-center space-y-4">
        ...
        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          Welcome to the most delightful content management experience ever
          created! Packed with perks, rewards, and intelligent automation to
          make your content journey effortless. ✨
        </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <Card
          ...
          onClick={() => setActiveTab("focus-chart")}
        >
          <CardContent className="p-6 text-center">
            ...
            <p className="text-sm text-gray-600">
              Interactive niche mapping with drag-and-drop and gamified progress
              tracking
            </p>
          </CardContent>
        </Card>
        ...
        <Card
          className="hover:shadow-lg transition-shadow cursor-pointer"
          onClick={() => setActiveTab("topic-workflow")}
        >
          <CardContent className="p-6 text-center">
            ...
            <p className="text-sm text-gray-600">
              AI-powered 30-topic generation with playful A/B testing and smart
              suggestions
            </p>
          </CardContent>
        </Card>
        ...
        >
          <CardContent className="p-6 text-center">
            ...
            <p className="text-sm text-gray-600">
              Beautiful metrics with achievement badges and automated email
              reporting
            </p>
          </CardContent>
        </Card>
        ...
        >
          <CardContent className="p-6 text-center">
            ...
            <p className="text-sm text-gray-600">
              Two-phase SEO audit with friendly setup wizard and interactive
              guides
            </p>
          </CardContent>
        </Card>
