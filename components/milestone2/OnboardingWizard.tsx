...
export function OnboardingWizard({ onComplete, userTier = 'pro' }: OnboardingWizardProps) {
  ...
  const deepAuditSteps: AuditStep[] = [
    ...quickAuditSteps,
    {
      ...
      description: 'Comprehensive technical analysis including schema, crawlability',
      status: 'pending',
      duration: 120
    },
    {
  ...
  const onboardingSteps: OnboardingStep[] = [
    {
      ...
      description: 'Let\'s get you set up with the most powerful content management system',
      completed: false,
      optional: false,
      estimatedTime: '2 min',
    ...
    },
    {
      ...
      description: 'Add your website URL so we can start optimizing your content',
      completed: false,
      optional: false,
      estimatedTime: '1 min',
    ...
    },
    {
      ...
      description: 'Run a comprehensive audit to identify optimization opportunities',
      completed: false,
      optional: false,
    ...
    },
    {
      ...
      description: 'Link Google Analytics 4 and Search Console for powerful insights',
      completed: false,
      optional: false,
      estimatedTime: '3 min',
  ...
  const runAudit = async () => {
    ...
    const totalDuration = stepsToRun.reduce((sum, step) => sum + step.duration, 0);
    let elapsed = 0;
    ...
    for (let i = 0; i < stepsToRun.length; i++) {
      ...
      setAuditSteps(prev => prev.map(s => 
        s.id === step.id ? { ...s, status: 'completed' as const, result: mockResult } : s
      ));
    }
    ...
    setSteps(prev => prev.map(s => 
      s.id === 'seo-audit' ? { ...s, completed: true } : s
    ));
  };
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="text-center">
        ...
        <p className="text-lg text-gray-600 mb-4">
          Let's get you set up in just a few minutes. Your content empire awaits!
        </p>
            ...
            <div className="text-center space-y-6">
              ...
              <div>
                ...
                <p className="text-gray-600 mb-6">
                  Orion CMS Pro will help you create, optimize, and scale your content like never before. 
                  With AI-powered insights, automated workflows, and beautiful analytics, you're about to 
                  experience content management that actually works.
                </p>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                  <div className="p-4 bg-blue-50 rounded-lg">
                    <Zap className="h-8 w-8 text-blue-600 mb-2" />
                    <h4 className="font-semibold text-gray-900">AI-Powered</h4>
                    <p className="text-sm text-gray-600">Smart topic generation and optimization</p>
                  </div>
                  ...
                  <div className="p-4 bg-purple-50 rounded-lg">
                    ...
                    <p className="text-sm text-gray-600">Streamlined publishing workflows</p>
                  </div>
                </div>
              </div>
              <Button 
          ...
          {currentStep === 1 && (
            <div className="space-y-6">
              <div className="text-center mb-6">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-2">Connect Your Website</h3>
                <p className="text-gray-600">
                  Enter your website URL so we can start analyzing and optimizing your content.
                </p>
              </div>
          ...
          {currentStep === 2 && (
            <div className="space-y-6">
              <div className="text-center mb-6">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-2">SEO Health Check</h3>
                <p className="text-gray-600">
                  Choose your audit type. Quick audits take 2 minutes, deep audits provide comprehensive insights in 15 minutes.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                ...
                >
                  <CardContent className="p-4">
                    ...
                    <p className="text-sm text-gray-600">
                      Essential SEO checks including meta tags, performance, and mobile optimization.
                    </p>
                  </CardContent>
                </Card>
                ...
                >
                  <CardContent className="p-4">
                    ...
                    <p className="text-sm text-gray-600">
                      Comprehensive analysis including technical SEO, competitors, and keyword opportunities.
                    </p>
                  </CardContent>
                </Card>
              </div>
                  ...
                  <CardContent className="p-6">
                    <div className="text-center mb-4">
                      ...
                      <h4 className="text-lg font-semibold text-gray-900 mb-2">
                        Running {auditType === 'quick' ? 'Quick' : 'Deep'} Audit...
                      </h4>
                      <Progress value={auditProgress} className="h-3 mb-2" />
                      <p className="text-sm text-gray-600">
                        {auditProgress.toFixed(0)}% complete - Analyzing your website
                      </p>
                    </div>
                    ...
                    <div className="text-center mb-4">
                      ...
                      <p className="text-gray-600 mb-4">
                        ...
                        <span className="font-bold text-green-600">
                          {Math.round(auditSteps.reduce((sum, step) => sum + (step.result?.score || 0), 0) / auditSteps.length)}%
                        </span>
                      </p>
                    </div>
          ...
          {currentStep === 3 && (
            <div className="space-y-6">
              <div className="text-center mb-6">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-2">Connect Your Analytics</h3>
                <p className="text-gray-600">
                  Link Google Analytics 4 and Search Console for powerful insights and automated reporting.
                </p>
              </div>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <Card className={ga4Connected ? 'bg-green-50 border-green-200' : ''}>
                  <CardContent className="p-6">
                    <div className="flex items-center gap-3 mb-4">
                      <BarChart3 className="h-8 w-8 text-blue-600" />
                      <div>
                        <h4 className="font-semibold">Google Analytics 4</h4>
                        <p className="text-sm text-gray-600">Track user behavior and conversions</p>
                      </div>
                    </div>
                ...
                <Card className={gscConnected ? 'bg-green-50 border-green-200' : ''}>
                  <CardContent className="p-6">
                    <div className="flex items-center gap-3 mb-4">
                      <Search className="h-8 w-8 text-green-600" />
                      <div>
                        <h4 className="font-semibold">Search Console</h4>
                        <p className="text-sm text-gray-600">Monitor search performance</p>
                      </div>
                    </div>
