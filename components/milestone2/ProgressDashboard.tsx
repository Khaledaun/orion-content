...
export function ProgressDashboard({ userTier = 'pro' }: ProgressDashboardProps) {
  ...
  const getTrendIcon = (trend: string, change: number) => {
    ...
    if (trend === 'down') return <ChevronDown className="h-4 w-4 text-red-600" />;
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Track your content empire's growth with beautiful insights and achievement rewards! 🏆
          </p>
        </div>
                ...
                {metric.target && (
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-gray-500">
                      {(metric.target - metric.value).toLocaleString()} {metric.unit} to goal
                    </p>
                  </div>
                )}
              </div>
              ...
              <CardContent>
                <div className="h-64 flex items-center justify-center bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg">
                  <div className="text-center">
                    ...
                    <p className="text-sm text-gray-500">Showing {selectedPeriod} traffic data</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  {metrics.filter(m => m.target).map((metric, index) => (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <Card className="lg:col-span-2">
              <CardHeader>
                ...
                <CardDescription>Your best articles from the last {selectedPeriod}</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  {[
                    { title: 'Best Sustainable Phone Cases for 2024', views: 12500, engagement: '4.2 min' },
                    { title: 'Remote Work Productivity: 15 Tools That Actually Work', views: 8900, engagement: '3.8 min' },
                    { title: 'MacBook Pro M3 vs M2: The Honest Comparison', views: 7600, engagement: '5.1 min' }
                  ].map((article, index) => (
                    <div key={index} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                      <div>
                        <h4 className="font-medium text-gray-900">{article.title}</h4>
                        <p className="text-sm text-gray-600">
                          {article.views.toLocaleString()} views • {article.engagement} avg. engagement
                        </p>
                      </div>
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="p-4 bg-blue-50 rounded-lg">
                    <h4 className="font-semibold text-blue-900 mb-2">🎯 Top Tip</h4>
                    <p className="text-sm text-blue-800">
                      Your tech review articles get 40% more engagement than average!
                    </p>
                  </div>
                  ...
                  <div className="p-4 bg-purple-50 rounded-lg">
                    <h4 className="font-semibold text-purple-900 mb-2">✨ Achievement</h4>
                    <p className="text-sm text-purple-800">
                      You're close to unlocking "SEO Master" - just 3 more points!
                    </p>
                  </div>
                </div>
              </CardContent>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-3">
                  {[
                    { keyword: 'sustainable phone cases', position: 3, change: '+5' },
                    { keyword: 'remote work tools 2024', position: 7, change: '+12' },
                    { keyword: 'macbook pro comparison', position: 2, change: '+3' }
                  ].map((win, index) => (
                    <div key={index} className="flex items-center justify-between p-3 bg-green-50 rounded-lg">
                      <div>
                        <p className="font-medium text-gray-900">"{win.keyword}"</p>
                        <p className="text-sm text-gray-600">Position #{win.position}</p>
                      </div>
              ...
              <CardContent>
                <div className="h-64 flex items-center justify-center bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg">
                  <div className="text-center">
                    ...
                    <p className="text-sm text-gray-500">Average session: 4.2 minutes</p>
                  </div>
                </div>
              </CardContent>
            </Card>
      ...
      <Card className="bg-gradient-to-r from-blue-50 to-indigo-50 border-blue-200">
        <CardHeader>
          ...
          <CardDescription>
            Get beautiful progress reports delivered to your inbox automatically! 📧
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="p-4 bg-white rounded-lg border border-blue-200">
              <h4 className="font-semibold text-gray-900 mb-2">📈 Monthly Deep Dive</h4>
              <p className="text-sm text-gray-600 mb-3">
            ...
            <div className="p-4 bg-white rounded-lg border border-blue-200">
              <h4 className="font-semibold text-gray-900 mb-2">🎯 Goal Alerts</h4>
              <p className="text-sm text-gray-600 mb-3">
