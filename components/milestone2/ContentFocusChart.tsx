    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Drag and drop to prioritize your content niches. Watch your SEO reach goals come to life! 🚀
          </p>
        </div>
        <Button onClick={addNewNiche} className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card className="border-l-4 border-l-blue-500">
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600">Total Search Volume</p>
                <p className="text-2xl font-bold text-gray-900">
                  {niches.reduce((sum, n) => sum + n.searchVolume, 0).toLocaleString()}
                </p>
              </div>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">
                  {Math.round(niches.reduce((sum, n) => sum + n.engagementScore, 0) / niches.length)}%
                </p>
              </div>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">
                  {Math.round(
                    niches.reduce((sum, n) => sum + calculateProgress(n.currentReach, n.seoReachGoal), 0) / niches.length
                  )}%
                </p>
              </div>
      ...
      <Card className="overflow-hidden">
        <CardHeader className="bg-gradient-to-r from-blue-50 to-purple-50">
          ...
          <CardDescription>
            Drag to reorder by priority. Click to edit. Watch your engagement badges grow! ✨
          </CardDescription>
        </CardHeader>
                            ...
                            <div className="flex items-start gap-4 flex-1">
                              ...
                              <div className="flex-1">
                                <div className="flex items-center gap-3 mb-2">
                                  <div className={`w-4 h-4 rounded-full ${niche.color}`} />
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                                  ...
                                  <div>
                                    ...
                                    <Badge className={`text-xs ${getCompetitionColor(niche.competition)}`}>
                                      {niche.competition}
                                    </Badge>
                                  </div>
                                  <div>
                                    <Label className="text-xs text-gray-500">Engagement</Label>
                                    <p className="font-semibold text-green-600">{niche.engagementScore}%</p>
                                  </div>
                                  <div>
                                    <Label className="text-xs text-gray-500">Audience</Label>
                                    <p className="text-sm text-gray-700">{niche.targetAudience}</p>
                                  </div>
                                </div>
                                ...
                                <div className="space-y-2">
                                  <div className="flex justify-between items-center">
                                    <Label className="text-sm font-medium">SEO Reach Goal</Label>
                                    <span className="text-sm text-gray-600">
                                      {niche.currentReach.toLocaleString()} / {niche.seoReachGoal.toLocaleString()}
                                    </span>
                                  </div>
                                  <Progress 
                                    value={calculateProgress(niche.currentReach, niche.seoReachGoal)} 
                                    className="h-2"
                                  />
                                  <p className="text-xs text-gray-500">
                                    {calculateProgress(niche.currentReach, niche.seoReachGoal).toFixed(1)}% complete
                                  </p>
                                </div>
                              </div>
                            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-4 bg-white rounded-lg border border-yellow-200">
              ...
              <p className="text-sm text-gray-600">
                Your "Sustainable Living" niche has 92% engagement! Consider creating more content in this area.
              </p>
            </div>
            <div className="p-4 bg-white rounded-lg border border-yellow-200">
              <h4 className="font-semibold text-gray-900 mb-2">📈 Growth Opportunity</h4>
              <p className="text-sm text-gray-600">
                "Remote Work Tools" has low competition and good search volume. Perfect for expansion!
              </p>
            </div>
          </div>
        </CardContent>
