    ...
    <div className="space-y-6">
      ...
      <div className="text-center py-8">
        ...
        <p className="text-gray-600 max-w-md mx-auto">
          Your integrations are configured and ready to go. Let's explore what
          you can do with Orion CMS.
        </p>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>These integrations are ready to use</CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Explore these powerful features</CardDescription>
        </CardHeader>
        <CardContent>
